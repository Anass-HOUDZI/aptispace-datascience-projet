...
#| fig-cap: "Visualisation interactive des données avec Plotly."
#| echo: false
import pandas as pd
import numpy as np
...
# Utilisation de la nouvelle fonction Plotly
fig = uv.plot_interactive_scatter(df_sample, x_col='Feature_A', y_col='Feature_B', color_col='Category')
fig.show()
```
[Ce graphique est généré avec Plotly et sera entièrement interactif dans la version HTML du rapport.]
